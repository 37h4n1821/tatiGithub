...
public class MascotaDatos extends javax.swing.JFrame {
    ...
    public void establecerDatos(Mascota mascota){
        ...
        ComboDueños.setSelectedItem(mascota.getDueño().getRut()+"-"+mascota.getDueño().getDv());
        Fecha_Nacimiento.setDate(mascota.getFecNac().toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
